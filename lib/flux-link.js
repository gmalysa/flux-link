...
/**
 * If true, this chain will use a local environment, introducing a private local scope (so that
 * changes to env made inside are not visible to the caller)
 * @param bool local If true a local environment will be created, otherwise the parent is used
 */
cbp.use_local_env = function(local) {
	this.local_env = local;
	return this;
}
