...
_.extend(Chain.prototype, {
	/**
	 * Produce a representation of this chain as a graph in the DOT language, suitable for sending
	 * to graphviz.
	 *
	 * Ignore this for now, need to finish it later, but implementing additional patterns first
	 */
//	generate_dot : function() {
//		this.fns.reduce(function(memo, v) {
//		}, '');
//	},

	/**
	 * Internally used function to generate DOT text, public wrapper assigns the parameter appropriately
	 * @param g If true, create a graph statement, if false, create using a subgraph statement
	 */
//	_gen_dot_int : function(names, next, g) {
//		this.fns.reduce(function(memo, v) {
//			var fn_name = v.name;	
//		}, '');
//	},
...
_.extend(LoopChain.prototype, {
	...
	apply : function(ctx, args) {
		...
		handle = function(result) {
			if (result) {
				var params = that.handle_args(env, info, slice.call(arguments, 1));
