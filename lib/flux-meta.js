...
function FluxMeta(env, log) {
	this.stack = [];
	this.call_first = null;
	this.call_current = null;
	this.call_stack = [];
	this.exception_stack = [];
	this.exception_after = undefined;
	this.$log = log;
}

var fmp = FluxMeta.prototype;

/**
 * Pushes a value onto the stack
 * @param val Value to push on the stack
 */
fmp.$push_stack = function(val) {
	this.stack.push(val);
}
 ...
 */
fmp.$push_exception_handler = function(h, after) {
 ...
 */
fmp.$pop_exception_handler = function() {
 ...
 */
fmp.$get_exception_after = function() {
 ...
 */
fmp.$format_call_tree = function(bt) {
 ...
 */
fmp.$format_stack_trace = function(bt) {
	var depth = 0;
