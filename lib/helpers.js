...
/**
 * Noop function, used when I need a function for consistency of interface but none
 * was supplied by the user (and when it isn't a critical failure for them to not
 * supply one)
 */
